                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr class="align-middle">
                        ...
                        <th class="align-middle">
                            Cantidad <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Max Quantity: 100"></i>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        @else
                            <td colspan="3" class="text-center">
                                <span class="text-danger"> Por favor busque y seleccione un producto! </span>
                            </td>
                        @endif
                    </tr>
                    </tbody>
